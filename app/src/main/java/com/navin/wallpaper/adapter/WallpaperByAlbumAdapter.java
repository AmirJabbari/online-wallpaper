...
public class WallpaperByAlbumAdapter extends RecyclerView.Adapter<WallpaperByAlbumAdapter.ViewHolder> {

    List<Wallpaper> wallpaperList=new ArrayList<>();
    Context context;

    public WallpaperByAlbumAdapter(Context context,List<Wallpaper> wallpapers){
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        ...
        return new WallpaperByAlbumAdapter.ViewHolder(view);
    }
